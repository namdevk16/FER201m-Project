    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light fixed-top" style={mistype}>
            <div className="container">
                ...
                <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controlsName="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
